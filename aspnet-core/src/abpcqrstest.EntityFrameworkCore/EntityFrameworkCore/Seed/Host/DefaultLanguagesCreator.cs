...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = abpcqrstestConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(abpcqrstestDbContext context)
    {
        _context = context;
    }
