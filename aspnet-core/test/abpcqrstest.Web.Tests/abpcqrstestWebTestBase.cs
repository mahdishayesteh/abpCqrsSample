...
public abstract class abpcqrstestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static abpcqrstestWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(abpcqrstestWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<abpcqrstestDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<abpcqrstestDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<abpcqrstestDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<abpcqrstestDbContext, Task<T>> func)
    {
        T result;
